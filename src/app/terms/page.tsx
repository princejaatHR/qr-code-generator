...
export const metadata: Metadata = {
	...
	description:
		"Terms and conditions for using our QR code generator service.",
};
		...
		<div className='container mx-auto py-12 md:py-16 lg:py-20'>
			<div className='max-w-3xl mx-auto'>
				...
				<div className='prose prose-sm sm:prose dark:prose-invert max-w-none'>
					...
					<p>
						Welcome to QR Code Generator. These Terms of Service
					...
					<p>
						QR Code Generator provides a platform for creating and
						customizing QR codes. You may use our service to
					...
					<p>
						...
						your use of the service. You agree not to use the
						service for any illegal purposes or to conduct any
						illegal activity, including, but not limited to, fraud,
					...
					<p>
						...
						functionality are owned by QR Code Generator and are
					...
					<p>
						You retain all rights to the content you input to
						generate QR codes. However, by using our service, you
						grant us a non-exclusive, royalty-free license to use,
						store, and process that content solely for the purpose
					...
					<p>
						In no event shall QR Code Generator be liable for any
