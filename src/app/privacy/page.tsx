...
export const metadata: Metadata = {
	...
	description:
		"Privacy policy for our QR code generator service, detailing how we handle your data.",
};
		...
		<div className='container mx-auto py-12 md:py-16 lg:py-20'>
			<div className='max-w-3xl mx-auto'>
				...
				<div className='prose prose-sm sm:prose dark:prose-invert max-w-none'>
					...
					<p>
						At QR Code Generator, we respect your privacy and are
					...
					<p>
						The content you input to generate QR codes is processed
						in your browser. We do not store the content of your QR
						codes on our servers. The QR codes you generate are
						created client-side and are not saved unless you choose
						to download them.
					</p>
					...
					<p>
						...
						information from children under 13. If we discover that
